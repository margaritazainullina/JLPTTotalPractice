...
public class GrammarExampleService {
     ...
     *
     * @param g        GrammarExample instance to insert
     * @param ruleId id of a Grammar example belongs to
     * @param cr       content resolver to database
     */
     ...
     *
     * @param ruleId id of a grammar rule to which grammar example belongs
     * @param cr        - content resolver to database
    ...
    public ArrayList<GrammarExample> getAllExamplesWithWord(String word,
                                                            ContentResolver cr) {
        String[] col = {GrammarExamplesDAO.RULE_ID, GrammarExamplesDAO.TEXT,
                GrammarExamplesDAO.ROMAJI, GrammarExamplesDAO.TRANSLATION_ENG,
                GrammarExamplesDAO.TRANSLATION_RUS};
        Cursor c = cr.query(GrammarExamplesDAO.CONTENT_URI, col,
                GrammarExamplesDAO.TEXT + " LIKE '%" + word + "%'", null, null, null);
        c.moveToFirst();
        String text = "";
        String romaji = "";
        String eng = "";
