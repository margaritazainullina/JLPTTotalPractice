...
public class User {
    ...
    private int isVocLaunchedFirstTime = 1;
    private int isGrammarLaunchedFirstTime = 1;
    private int isGiongoLaunchedFirstTime = 1;
    private int isCWLaunchedFirstTime = 1;
	...
	public User(int id, int userLevel, int learnedVocabulary,
            ...
            int isVocLaunchedFirstTime, int isGrammarLaunchedFirstTime,
            int isGiongoLaunchedFirstTime, int isCWLaunchedFirstTime,
			int isCurrentLevel) {
		super();
		this.id = id;
        ...
        this.isVocLaunchedFirstTime = isVocLaunchedFirstTime;
        this.isGrammarLaunchedFirstTime = isGrammarLaunchedFirstTime;
        this.isGiongoLaunchedFirstTime = isGiongoLaunchedFirstTime;
        this.isCWLaunchedFirstTime = isCWLaunchedFirstTime;
    ...
    public int getIsVocLaunchedFirstTime() {
        return isVocLaunchedFirstTime;
    }

    public void setIsVocLaunchedFirstTime(int isVocLaunchedFirstTime) {
        this.isVocLaunchedFirstTime = isVocLaunchedFirstTime;
    }

    public int getIsGrammarLaunchedFirstTime() {
        return isGrammarLaunchedFirstTime;
    }

    public void setIsGrammarLaunchedFirstTime(int isGrammarLaunchedFirstTime) {
        this.isGrammarLaunchedFirstTime = isGrammarLaunchedFirstTime;
    }

    public int getIsGiongoLaunchedFirstTime() {
        return isGiongoLaunchedFirstTime;
    }

    public void setIsGiongoLaunchedFirstTime(int isGiongoLaunchedFirstTime) {
        this.isGiongoLaunchedFirstTime = isGiongoLaunchedFirstTime;
    }

    public int getIsCWLaunchedFirstTime() {
        return isCWLaunchedFirstTime;
    }

    public void setIsCWLaunchedFirstTime(int isCWLaunchedFirstTime) {
        this.isCWLaunchedFirstTime = isCWLaunchedFirstTime;
    }
}
