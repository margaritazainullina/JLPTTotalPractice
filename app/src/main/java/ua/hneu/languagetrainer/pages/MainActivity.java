...
public class MainActivity extends FragmentActivity implements
    ...
    private android.widget.ListView countersListView;
    private View cwFragment;
...
*/
    ...
    public void onTabSelected(Tab tab, FragmentTransaction ft) {
        ...
        try {
            ...
            cwFragment = findViewById((getSupportFragmentManager().findFragmentByTag(tag)).getId());
            countersListView = (android.widget.ListView) cwFragment.findViewById(R.id.sectionsListView);
        } catch (Exception e) {
        }
    }
    ...
    public void onClickShowTranslationButton(View v) {
        try {
            String tag = "android:switcher:" + R.id.pager + ":" + viewPager.getCurrentItem();
            View cwFragment = findViewById((getSupportFragmentManager().findFragmentByTag(tag)).getId());
            TextView translationTextView = (TextView) (cwFragment.findViewById(R.id.translationTextView));
            Button showTranslationButton = (Button) (cwFragment.findViewById(R.id.showTranslationButton));
            showTranslationButton.setVisibility(View.INVISIBLE);
            translationTextView.setAlpha(1);

        }catch(Exception e){}
    }

    public void onClickShowGrammarTranslation(View v) {
        try {
            String tag = "android:switcher:" + R.id.pager + ":" + viewPager.getCurrentItem();
            View cwFragment = findViewById((getSupportFragmentManager().findFragmentByTag(tag)).getId());
            TextView translationTextView = (TextView) (cwFragment.findViewById(R.id.translationGrammarTextView));
            Button showTranslationButton = (Button) (cwFragment.findViewById(R.id.showGrammarTranslationButton));
            showTranslationButton.setHeight(0);
            showTranslationButton.setVisibility(View.INVISIBLE);
            translationTextView.setAlpha(1);
        }catch(Exception e){}
    }

    public void onClickShowGiongoTranslation(View v) {
        try {
            String tag = "android:switcher:" + R.id.pager + ":" + viewPager.getCurrentItem();
            View cwFragment = findViewById((getSupportFragmentManager().findFragmentByTag(tag)).getId());
            TextView translationTextView = (TextView) (cwFragment.findViewById(R.id.translationGiongoTextView));
            Button showTranslationButton = (Button) (cwFragment.findViewById(R.id.showTranslationGiongoButton));
            showTranslationButton.setHeight(0);
            showTranslationButton.setVisibility(View.INVISIBLE);
            translationTextView.setAlpha(1);
        }catch(Exception e){}
    ...
    public void onClickShowCWTranslation(View v) {
        try {
            String tag = "android:switcher:" + R.id.pager + ":" + viewPager.getCurrentItem();
            View cwFragment = findViewById((getSupportFragmentManager().findFragmentByTag(tag)).getId());
            TextView translationTextView = (TextView) (cwFragment.findViewById(R.id.translationCWTextView));
            Button showTranslationButton = (Button) (cwFragment.findViewById(R.id.showTranslationCWButton));
            showTranslationButton.setHeight(0);
            showTranslationButton.setVisibility(View.INVISIBLE);
            translationTextView.setAlpha(1);
        }catch(Exception e){}
